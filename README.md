...
frontend/
  ...
  css/style.css      — стили
  js/                — ES-модули приложения (app.js, api.js, timeline.js, utils.js)
data/
...
Этот проект распространяется под Business Source License 1.1 с дополнительными
условиями. Полный текст — в файле [LICENSE](LICENSE).

- **Бесплатно:** для личного, образовательного и научного использования.
- **Бесплатно:** если ваш продукт добавляет значительную ценность сверх моего кода (вы создали своё приложение, а мой код — только вспомогательная библиотека).
- **Платно:** если вы продаёте мой код как есть, сдаёте его в аренду или предоставляете как готовый SaaS-сервис.
- **Платно:** если вы используете мой код в коммерческом продукте как его основную функциональность.

Для коммерческой лицензии пишите: gagelov838@gmail.com
